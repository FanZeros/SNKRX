-- SNKRX Engine: State mixin + Main state machine
-- Ported to UrhoX: no changes needed (pure Lua)
...
-- The main state machine. Contains all game states (MainMenu, Arena, BuyScreen).
Main = Object:extend()
